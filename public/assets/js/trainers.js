var jsonDataUrl = '../public/assets/json/trainers.json';
...
fetch(jsonDataUrl)
    ...
    .then(data => {
        ...
        if ($.fn.DataTable.isDataTable('#trainers_data')) {
            $('#trainers_data').DataTable().destroy();
        }
        var table = $('#trainers_data').DataTable({
            ordering: true,
            data: data,
            columns: [
                { data: 'Id' },
