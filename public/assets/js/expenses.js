var jsonDataUrl = '../public/assets/json/expenses.json';
...
fetch(jsonDataUrl)
    ...
    .then(data => {
        ...
        if ($.fn.DataTable.isDataTable('#expenses_data')) {
            $('#expenses_data').DataTable().destroy();
        }
        var table = $('#expenses_data').DataTable({
            ordering: true,
            data: data,
            columns: [
                {
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a class="dropdown-item" href="#" data-bs-toggle="modal"
                                data-bs-target="#delete_expense"><i class="fa-regular fa-trash-can m-r-5"></i> Delete</a>
                        </div>
            `;
                        return AvatarHtml;
                    }
