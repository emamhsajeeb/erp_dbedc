var jsonDataUrl = '../public/assets/json/assets_new.json';
...
fetch(jsonDataUrl)
    ...
    .then(data => {
        ...
        if ($.fn.DataTable.isDataTable('#assets_new_data')) {
            $('#assets_new_data').DataTable().destroy();
        }
        var table = $('#assets_new_data').DataTable({
            ordering: true,
            data: data,
            columns: [
                { data: 'id' },
