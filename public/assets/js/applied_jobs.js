var jsonDataUrl = '../public/assets/json/applied_jobs.json';
...
fetch(jsonDataUrl)
    ...
    .then(data => {
        ...
        if ($.fn.DataTable.isDataTable('#applied_jobs_data')) {
            $('#applied_jobs_data').DataTable().destroy();
        }
        var table = $('#applied_jobs_data').DataTable({
            ordering: true,
            data: data,
            columns: [
                { data: 'id' },
