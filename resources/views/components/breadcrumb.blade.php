                       ...
                       <div class="col">
                           ...
                           <ul class="breadcrumb">
                               <li class="breadcrumb-item"><a
                                       href="{{ url('admin-dashboard') }}">{{ $li_1 }}</a></li>
                               <li class="breadcrumb-item active">{{ $li_2 }}</li>
                               @if (Route::is([
                                       'candidates',
                                       'experiance-level',
                       ...
                       <div class="col-auto float-end ms-auto">
                               ...
                               <ul class="split-head">
                                   <li>
                                       <a href="#" class="btn add-btn" data-bs-toggle="modal"
                                           data-bs-target="#add_asset"><i class="fa fa-plus"></i> Add Category</a>
                                   </li>
                               </ul>
                           @endif
                           @if (Route::is(['assets-new']))
                               <ul class="split-head">
                                   ...
                                   <li>
                                       <a href="#" class="btn add-btn" data-bs-toggle="modal"
                                           data-bs-target="#add_asset"><i class="fa fa-plus"></i> Add New Asset</a>
                                   </li>
                               </ul>
                           @endif
                           @if (Route::is(['assets1']))
                           ...
                           @if (Route::is(['budget-expenses']))
                               <a href="#" class="btn add-btn" data-bs-toggle="modal"
                                   data-bs-target="#add_categories"><i class="fa fa-plus"></i> Add Expenses</a>
                           @endif

                           @if (Route::is(['budget-revenues']))
                               <a href="#" class="btn add-btn" data-bs-toggle="modal"
                                   data-bs-target="#add_categories"><i class="fa fa-plus"></i> Add Revenues</a>
                           @endif
                           @if (Route::is(['budgets']))
                               <a href="#" class="btn add-btn" data-bs-toggle="modal"
                                   data-bs-target="#add_categories"><i class="fa fa-plus"></i> Add Budgets</a>
                           @endif
                           @if (Route::is(['candidates']))
                               <a href="#" data-bs-toggle="modal" data-bs-target="#add_employee"
                                   class="btn add-btn"> Add Candidates</a>
                           @endif
                           @if (Route::is(['categories']))
                               <a href="#" class="btn add-btn" data-bs-toggle="modal"
                                   data-bs-target="#add_categories"><i class="fa fa-plus"></i> Add Categories</a>
                           @endif
                           ...
                           @if (Route::is(['events']))
                               <a href="#" class="btn add-btn" data-bs-toggle="modal"
                                   data-bs-target="#add_event"><i class="fa fa-plus"></i> Add Event</a>
                           @endif
                           @if (Route::is(['expenses']))
                               <a href="#" class="btn add-btn" data-bs-toggle="modal"
                                   data-bs-target="#add_expense"><i class="fa fa-plus"></i> Add Expense</a>
                           @endif
                           @if (Route::is(['experiance-level']))
                               <a href="#" data-bs-toggle="modal" data-bs-target="#add_employee"
                                   class="btn add-btn"> Add Experience Level</a>
                           @endif
                           ...
                           @if (Route::is(['goal-type']))
                               <a href="#" class="btn add-btn" data-bs-toggle="modal"
                                   data-bs-target="#add_type"><i class="fa fa-plus"></i> Add New</a>
                           @endif
                           @if (Route::is(['performance-indicator']))
                               <a href="#" class="btn add-btn" data-bs-toggle="modal"
                                   data-bs-target="#add_indicator"><i class="fa fa-plus"></i> Add New</a>
                           @endif
                           ...
                           @if (Route::is(['interview-questions']))
                               <a href="#" class="btn add-btn mb-1" data-bs-toggle="modal"
                                   data-bs-target="#add_question"><i class="fa fa-plus"></i> Add Question</a>
                           ...
                           @if (Route::is(['jobs']))
                               <a href="#" class="btn add-btn" data-bs-toggle="modal"
                                   data-bs-target="#add_job"><i class="fa fa-plus"></i> Add Job</a>
                           @endif
                           @if (Route::is(['leave-type']))
                               <a href="#" class="btn add-btn" data-bs-toggle="modal"
                                   data-bs-target="#add_leavetype"><i class="fa fa-plus"></i> Add Leave Type</a>
                           @endif
                           ...
                           @if (Route::is(['policies']))
                               <a href="#" class="btn add-btn" data-bs-toggle="modal"
                                   data-bs-target="#add_policy"><i class="fa fa-plus"></i> Add Policy</a>
                           @endif
                           ...
                           @if (Route::is(['provident-fund']))
                               <a href="#" class="btn add-btn" data-bs-toggle="modal"
                                   data-bs-target="#add_pf"><i class="fa fa-plus"></i> Add Provident Fund</a>
                           @endif
                           ...
                           @if (Route::is(['salary']))
                               <a href="#" class="btn add-btn" data-bs-toggle="modal"
                                   data-bs-target="#add_salary"><i class="fa fa-plus"></i> Add Salary</a>
                           @endif
                           ...
                           @if (Route::is(['sub-category']))
                               <a href="#" class="btn add-btn" data-bs-toggle="modal"
                                   data-bs-target="#add_categories"><i class="fa fa-plus"></i> Add Sub
                                   Categories</a>
                           @endif
                           ...
                           @if (Route::is(['taxes']))
                               <a href="#" class="btn add-btn" data-bs-toggle="modal"
                                   data-bs-target="#add_tax"><i class="fa fa-plus"></i> Add Tax</a>
                           @endif
                           ...
                           @if (Route::is(['users']))
                               <a href="#" class="btn add-btn" data-bs-toggle="modal"
                                   data-bs-target="#add_user"><i class="fa fa-plus"></i> Add User</a>
                           @endif
                       </div>
                           ...
                           <div class="col-auto float-end ms-auto">
                               ...
                               @if (Route::is(['project-view']))
                                   <a href="#" class="btn add-btn" data-bs-toggle="modal"
                                       ...
                                       Project</a>
                                   <a href="{{ url('task-board') }}" class="btn btn-white float-end me-3"
                                       data-bs-toggle="tooltip" title="Task Board"><i
                               ...
                               <div class="view-icons">
                                   ...
                                   @if (Route::is(['project-list']))
                                       <a href="{{ url('projects') }}" class="grid-view btn btn-link"><i
                                               class="fa fa-th"></i></a>
