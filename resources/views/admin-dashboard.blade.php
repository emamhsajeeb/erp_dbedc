    ...
    <div class="row">
            ...
            <div class="card card-table flex-fill">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-nowrap custom-table mb-0" id="dashboard_invoices_data">
                            <thead>
                                <tr>
                                    <th>Invoice ID</th>
                                    <th>Client</th>
        ...
        <div class="col-md-6 d-flex">
            <div class="card card-table flex-fill">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table custom-table table-nowrap mb-0" id="dashboard_payments_data">
                            <thead>
                                <tr>
                                    <th>Invoice ID</th>
                                    <th>Client</th>
    ...
    <div class="row">
        <div class="col-md-6 d-flex">
            <div class="card card-table flex-fill">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table custom-table mb-0" id="dashboard_clients_data">
                            <thead>
                                <tr>
                                    <th>Name</th>
                                    <th>Email</th>
        ...
        <div class="col-md-6 d-flex">
            <div class="card card-table flex-fill">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table custom-table mb-0" id="">
                            <thead>
                                <tr>
                                    <th>Project Name </th>
                                    <th>Progress</th>
