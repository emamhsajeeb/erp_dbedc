                            ...
                            <table class="table table-striped custom-table">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="{{url('profile')}}" class="avatar"><img src="assets/img/profiles/avatar-21.jpg" alt="User Image"></a>
                                    ...
                                    <tr>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="{{url('profile')}}" class="avatar"><img src="assets/img/profiles/avatar-02.jpg" alt="User Image"></a>
                                    ...
                                    <tr>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="{{url('profile')}}" class="avatar"><img src="assets/img/profiles/avatar-09.jpg" alt="User Image"></a>
                                    ...
                                    <tr>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="{{url('profile')}}" class="avatar"><img src="assets/img/profiles/avatar-10.jpg" alt="User Image"></a>
                                    ...
                                    <tr>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="{{url('profile')}}" class="avatar"><img src="assets/img/profiles/avatar-05.jpg" alt="User Image"></a>
                                    ...
                                    <tr>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="{{url('profile')}}" class="avatar"><img src="assets/img/profiles/avatar-11.jpg" alt="User Image"></a>
                                    ...
                                    <tr>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="{{url('profile')}}" class="avatar"><img src="assets/img/profiles/avatar-19.jpg" alt="User Image"></a>
